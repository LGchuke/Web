...
var bindClick = function(i) {
  tabs[i].addEventListener('click', function(e) {
    ...
    newPart = document.querySelectorAll('.et-music-box-group')[i]
    oldPart = document.querySelectorAll('.et-music-box-group')[preState]


    var preGroup = document.querySelector('.et-music-box-group.active')
    if (preState > i) {
      // console.log(preState + ' > ' + i + ' so left')
      oldPart.classList.toggle('et-fadeOut-right')
      setTimeout(function() {
          oldPart.classList.toggle('active')
      }, delay)
      setTimeout(function() {
          oldPart.classList.toggle('et-fadeOut-right')
          newPart.classList.toggle('et-fadeIn-right')
      }, delay + delayDelta)
      setTimeout(function() {
